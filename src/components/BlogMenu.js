  ...
  <div className="blog-container mx-auto my-8">
    ...
    <div className="grid grid-cols-3 gap-4">
      <div className="blog-card">
        <div className="blog-card-image" style={{backgroundImage: 'url(https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Microsoft_.NET_logo.svg/225px-Microsoft_.NET_logo.svg.png) '}}></div>
